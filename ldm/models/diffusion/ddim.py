...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, cond, shape,
                      ...
                      ucg_schedule=None, progress_bar=True):
    ...
    def encode(self, x0, c, t_enc, use_original_steps=False, return_intermediates=None,
               unconditional_guidance_scale=1.0, unconditional_conditioning=None, callback=None, progress_bar=True):
        ...
        if progress_bar is True:
            iterator = tqdm(range(num_steps), desc='Encoding Image')
        for i in iterator:
